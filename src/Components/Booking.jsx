  ...
  <div className="row no-gutters">
    ...
    <div className="col">
      <div className="card-body">
        ...
        <p className="card-text my-4"><span className='f-b'>Screen : </span>{movie.screen}</p>
        <p className="card-text my-4"><span className='f-b'>Languages : </span>{movie.languages}</p>
        <p className="card-text my-4"><span className='f-b'>Certificate : </span>{movie.certificate}</p>
        <p className="card-text my-4"><span className='f-b'>Rating : </span>{movie.rating}</p>
      </div>
    </div>
  </div>
</div>
    ...
    You have selected <span id="count">{seats}</span> seat for a price of RS.<span id="total">{seats * 100}</span>
  </p>
        </div>
    ...
    <div className='container my-5 bg-book'>
      ...
      <Dropdown.Menu  >
        ...
        {
          theatre.map((t , index)=>{
        return( <Dropdown.Item eventKey={t.theatrename} key={index} href="">{t.theatrename}</Dropdown.Item>)
      ...
      <Dropdown.Menu >
        <Dropdown.Item eventKey="8.00 AM" href="">8.00 AM</Dropdown.Item>
        <Dropdown.Item eventKey="10.30 AM" href="">10.30 AM</Dropdown.Item>
        <Dropdown.Item eventKey="2.00 PM" href="">2.00 PM</Dropdown.Item>
        <Dropdown.Item eventKey="5.00 PM" href="">5.00 PM</Dropdown.Item>
        <Dropdown.Item eventKey="10.00 PM" href="">10.00 PM</Dropdown.Item>
      </Dropdown.Menu>
        </Dropdown>
            </div>
      ...
      <Dropdown.Menu>
        ...
        <Dropdown.Item eventKey="4" href="">4</Dropdown.Item>
...
<div className="row">
    ...
    {/* <button className='btn btn-danger' onClick={()=>Swal.fire({
  icon: 'success',
  title: 'Ticket Booked Succesfully',
  html: `<p>Booked seats :${seats}</p>
         <p>Timing :${timing} </p>
         <p>Theatre : ${theatre}</p>`
}
)}>Book Now</button> */}
